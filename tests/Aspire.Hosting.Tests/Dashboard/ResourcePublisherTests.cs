...
public class ResourcePublisherTests
{
    ...
    public async Task ProducesExpectedSnapshotAndUpdates()
    {
        ...
        await publisher.IntegrateAsync(a, ResourceSnapshotChangeType.Upsert);
        await publisher.IntegrateAsync(b, ResourceSnapshotChangeType.Upsert);
        ...
        await publisher.IntegrateAsync(c, ResourceSnapshotChangeType.Upsert);
    ...
    public async Task MergesResourcesInSnapshot()
    {
        ...
        await publisher.IntegrateAsync(a1, ResourceSnapshotChangeType.Upsert);
        await publisher.IntegrateAsync(a2, ResourceSnapshotChangeType.Upsert);
        await publisher.IntegrateAsync(a3, ResourceSnapshotChangeType.Upsert);
    ...
    public async Task DeletesRemoveFromSnapshot()
    {
        ...
        await publisher.IntegrateAsync(a, ResourceSnapshotChangeType.Upsert);
        await publisher.IntegrateAsync(b, ResourceSnapshotChangeType.Upsert);
        await publisher.IntegrateAsync(a, ResourceSnapshotChangeType.Delete);
    ...
    public async Task CancelledSubscriptionIsCleanedUp()
    {
        ...
        await publisher.IntegrateAsync(CreateResourceSnapshot("A"), ResourceSnapshotChangeType.Upsert);
